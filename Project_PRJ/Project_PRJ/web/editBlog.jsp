                    ...
                    <div class="row">
                        <div id="edit" class="main-content-wrap container">
                          <div class="content-header">
                            ...
                            <div>
                                <form action="adminEditBlog" method="post"  class="form-content margin-top-24 form" role="form" id="employee-form">
                                     
                                      <div class="row">
                                        <div class="form-body   col-xl-12 ">
                                            <div class="mb-3">
                                                <input hidden type="text" name="id" class="form-control" value="${blog.id}" >
                                             ...
                                             <div class="mb-3">
                                              ...
                                              <div class="row">
                                                   <div class="col-xl-1">
                                                       <button type="submit" class="width-100 font-size-inherit btn btn-info " id="btnEdit"><i class="fa-solid fa-edit"></i> Edit</button>
                                                </div>
