						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									...
									<input name="username" type="text" required="" class="form-control" value="${username}"></input>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group"> 
									<label>Your Password</label>
                                                                        <input name="password" type="password" class="form-control" required=""  value="${password}"></input>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
